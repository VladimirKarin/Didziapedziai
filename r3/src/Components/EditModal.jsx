...
function EditModal() {
    const { editModalTree, setEditModalTree, setEditTree, types } =
        useContext(Global);
    ...
    const handleClick = (e) => {
        setInput((i) => ({
            ...i,
            [e.nativeEvent.target.getAttribute('name')]: e.target.value,
        }));
    };
                ...
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">
                            Please RE-plant this tree
                        </h5>
                        <button
                            type="button"
                            className="btn-close"
                            onClick={() => setEditModalTree(null)}
                        ></button>
                    </div>
                            ...
                            <div className="card-body">
                                ...
                                <div className="mb-3">
                                    <label className="form-label">
                                        Slide to height: {input.height / 100} m
                                    </label>
                                    <input
                                        type="range"
                                        min="0"
