...
function App() {
    ...
    // const addOne = () => {
    //     // setCount(count++) you're dead! don't edit state!
    //     // setCount(count + 1); // WARNING DON'T do like that! )
    //     // setCount(count + 1); // reiksmes redagavimas.
    //     // setCount((c) => ++c); //ne naudoti!
    //     setCount((c) => c + 1);
    //     setCount((c) => c + 1); // Visi bus ivikdyti.
    //     setCount((c) => c + 1);
    // };
    ...
    return (
        <div className="App">
            <header className="App-header">
                ...
                <button className="blue" onClick={changeColor2}>
                    Changes Color
                </button>

                <button className="blue" onClick={addOne}>
                    + 1
                </button> */}
                <div className="sq-bin">
                    {sq.map((s, i) => (
                ...
                <div className="sq-bin">
                    <button className="coral" onClick={addSq}>
                        + []
                    </button>

                    <button className="red" onClick={clearSq}>
                        clear
                    </button>

                    <button className="coral" onClick={changeColors}>
                        New
                    </button>
                </div>
            </header>
...
//                         clear
//                     </button>
//                     <button className="red" onClick={changeColors}>
//                         new
//                     </button>
//                 </div>
//             </header>
